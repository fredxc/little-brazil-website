...
export function SEO() {
  ...
  useEffect(() => {
    ...
    if (metaDescription) {
      ...
      meta.content =
        language === "pt"
          ? "Loja de produtos brasileiros autênticos em Amsterdam. Mate a saudade de casa com nossos produtos selecionados. Visite nossa loja na Raamsteeg 6."
          : "Authentic Brazilian products store in Amsterdam. Feel at home with our carefully selected products. Visit our store at Raamsteeg 6.";
