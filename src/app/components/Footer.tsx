      ...
      <div className="container mx-auto px-6">
        <div className="grid md:grid-cols-3 gap-12 mb-12">
          ...
          <div className="space-y-4">
            <img src={logoGreen} alt="Little Brazil Logo" className="w-16 h-16" />
            <h3
              className="text-2xl"
            ...
            <p className="text-emerald-200 text-sm" style={{ fontFamily: 'Copperplate, serif' }}>
              {t('footerTagline')}
            </p>
          </div>
          ...
          <div className="space-y-4">
            ...
            <div className="space-y-3 text-emerald-200">
              <div className="flex items-start gap-3">
                ...
                <span className="text-sm">Spuistraat 282, 1012 VX Amsterdam</span>
              </div>
              <div className="flex items-center gap-3">
                <Phone className="w-5 h-5 flex-shrink-0" />
                <a href="tel:+31612345678" className="text-sm hover:text-white transition-colors">
                  +31 6 1234 5678
                </a>
              </div>
              <div className="flex items-center gap-3">
        ...
        <div className="border-t border-emerald-800 pt-8 text-center text-emerald-300 text-sm">
          <p>© {currentYear} Little Brazil Amsterdam. {t('footerRights')}</p>
        </div>
      </div>
    </footer>
  );
